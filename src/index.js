...
class Editor extends React.Component{
    ...
    handleInput(){
        let elem = document.getElementById("textinp");
            elem = elem.value;
        this.props.sendData(elem);
    }
    render(){
        return(<div id="editor">
                <form>
                    <textarea onChange={this.handleInput} id="textinp" placeholder="Type text here...">
                    </textarea>
                </form>
                </div>)
    }
...
class Preview extends React.Component {
    render(){
        return (<div id="preview"  placeholder="Preview...">{this.props.prv}</div>)
    }
}
class MarkdownPrev extends React.Component{
    ...
    render(){
        return (<div className="container">
                <Editor sendData={this.handleEditorInput}/>
